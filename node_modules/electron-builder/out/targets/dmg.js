...
class DmgTarget extends (_electronBuilderCore || _load_electronBuilderCore()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            yield attachAndExecute(tempDmg, true, (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const artifactPath = _path.join(appOutDir, packager.expandArtifactNamePattern(packager.config.dmg, "dmg"));
            //noinspection SpellCheckingInspection
