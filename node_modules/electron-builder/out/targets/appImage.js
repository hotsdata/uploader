...
class AppImageTarget extends (_electronBuilderCore || _load_electronBuilderCore()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (_this.options.includeRequiredLib === true && arch === (_electronBuilderCore || _load_electronBuilderCore()).Arch.x64) {
                const libDir = yield (0, (_binDownload || _load_binDownload()).getBin)("AppImage-packages", "16.01.17", "https://bintray.com/electron-userland/bin/download_file?file_path=AppImage-packages-16.01.17-x64.7z", "4a2da2d718bc1f5c6ca2f3a58e0655f39e23450b43e20424679dedf9b9b1ecae");
